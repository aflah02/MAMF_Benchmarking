...
DECLARED_PEAK_TFLOPS_NO_SPARSITY: dict[str, dict[str, float]] = {
    ...
    "NVIDIA RTX PRO 6000 Blackwell Server Edition": {"bfloat16": 503.8, "float8_e4m3fn": 1007.6},
    "NVIDIA GB10": {"bfloat16": 125, "float8_e4m3fn": 250},
    "Tesla P100-SXM2-16GB": {"float16": 18.7},
}
...
def create_app() -> FastAPI:
    ...
    def home(request: Request, sort_by: str = "default") -> HTMLResponse:
        ...
        if is_hx(request):
            return render(request, "coverage_partial.html", context)
